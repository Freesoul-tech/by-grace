...
import { Phone, MapPin, Mail, ArrowRight, Check, Menu, X } from "lucide-react";
...
const products = [
  { title: "Kitchen Sinks", img: sink, desc: "Premium stainless steel sinks built to last." },
  { title: "Cabinet Doors", img: doors, desc: "Hand-crafted hardwood and labbing doors." },
  { title: "Cutting Boards", img: boards, desc: "Durable hardwood boards for every kitchen." },
  { title: "Dining Tables", img: tables, desc: "Elegant tables tailored to your space." },
  { title: "Kitchen Boards", img: doors, desc: "MDF and hardwood boards, finely finished." },
  { title: "Office Partitioning", img: office, desc: "Modern partitions for productive workspaces." },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="fixed top-0 inset-x-0 z-50 backdrop-blur-md bg-background/70 border-b border-border/60">
        <div className="container flex items-center justify-between h-16">
          <a href="#home" className="font-display text-lg font-bold text-primary tracking-tight">
            By Grace<span className="text-accent">.</span>
          </a>
      ...
      <section id="contact" className="py-24 md:py-32">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-16">
            ...
            <form
              onSubmit={(e) => { e.preventDefault(); window.location.href = "tel:+265882553923"; }}
            ...
            >
              ...
              <div>
                ...
                <input required className="mt-2 w-full bg-transparent border-b border-border py-2 focus:outline-none focus:border-accent transition-colors" />
              </div>
              <div>
                <label className="text-xs uppercase tracking-wider text-muted-foreground">Phone</label>
                <input required type="tel" className="mt-2 w-full bg-transparent border-b border-border py-2 focus:outline-none focus:border-accent transition-colors" />
              </div>
              <div>
                <label className="text-xs uppercase tracking-wider text-muted-foreground">What do you need?</label>
                <textarea rows={4} className="mt-2 w-full bg-transparent border-b border-border py-2 focus:outline-none focus:border-accent transition-colors resize-none" />
              </div>
